...
function Footer() {
    return (
        <footer class="bg-emerald-400 mt-24">
            <div class="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 text-center">
                <div className="inline-flex">
                    ...
                    <h1 className="text-3xl font-bold pt-4 pl-1">ChatSim!</h1>
                </div>
                ...
                <ul class="mt-12 flex justify-center gap-6 md:gap-8">
                    <li>
                        <Link
                            href="http://instagram.com/facunadez"
                            rel="noreferrer"
                            target="_blank"
            ...
            <span className="flex justify-center py-3 text-sm text-gray-100">Copyright © 2023. Created by Facundo Fernández. All rights reserved.</span>
        </footer>
    )
}
